      ...
      {palavra.split('').map((letra, index) => {
        ...
        return (
          <motion.div
            ...
            className="flex h-10 w-7 items-center justify-center border-b-4 border-slate-400 text-2xl font-bold text-slate-900 dark:border-slate-500 dark:text-slate-100 sm:h-12 sm:w-9 sm:text-3xl"
          >
            {revelada ? letra : ''}
          </motion.div>
        )
